...
export function isStringSchema(obj: JSONSchema): obj is JSONSchema.String {
  return isSchemaObject(obj) && 
    (obj.type === 'string' || obj.pattern !== undefined || obj.maxLength !== undefined || obj.minLength !== undefined);
}

// Number schema
export function isNumberSchema(obj: JSONSchema): obj is JSONSchema.Number {
  return isSchemaObject(obj) && 
    (obj.type === 'number' || obj.maximum !== undefined || obj.minimum !== undefined || obj.multipleOf !== undefined);
}
